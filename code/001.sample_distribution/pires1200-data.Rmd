...
Plots/statistics related to sample distributions across phylogroup, samples source (Food vs. Livestock) and antimicrobial gene presence (yes vs. no)
...
## Sample distribution across sampling year
